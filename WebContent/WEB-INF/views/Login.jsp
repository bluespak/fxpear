...
<head>
	...
	<title>Spark - Simple and effective</title>
	...
	<link rel="stylesheet" href="css/main-r9.css">
	<link rel="stylesheet" href="css/media-queries-r9.css">
	<link rel="stylesheet" href="css/sprites-r7.css">
...
<header>
	<div class="container">
		<div class="sixteen columns alpha omega">
			<h1 class="logo">
				<a href="/">
					<img src="img/logo.png" alt="Spark" class="scale-with-grid hide-for-mobiles" />
					<img src="img/logo-mobile.png" alt="Spark" class="scale-with-grid mobiles-only" /><!-- Alternative image for mobile devices -->
				</a>
			</h1>

			<nav class="menu">
				<ul>
					<li><a href="#home" class="active">Welcome<br /><span>to true performance</span></a></li>
					<li><a href="#features">Features<br /><span>limitless possibilities</span></a></li>
					<li><a href="#pricing">Pricing<br /><span>plans and options</span></a></li>
	...
	<div class="container">
		<div class="row box dark">
			<div class="seven columns">
				...
				<h1>Make it Yours</h1>
				<p>Designed with the latest technologies and most advanced techniques, this one-page website loads lightning-fast!</p>
				<p class="hide-for-tablets">The layout focus on usability, it offers enterprise-level features, design quality,
					technical implementation, compatibility, accessibility and performance.
				</p>
				<a href="#features" class="button call-to-action animate">Check Out The Features</a>
				</div>
			</div>
		...
		<div class="row">
			<div class="two-thirds column">
				...
				<ul class="tabs-content">
					<li class="active" id="simple">The tabs are clean and simple unordered-list markup and basic CSS.
						<ul class="square">
							<li>Google Fonts</li>
			...
			<div class="one-third column">
				...
				<p>Forms make use of the newest HTML5 tags and has graceful fallback for old browsers.</p>
	...
	<div class="container">
		...
		<div class="one-third column">
			<div class="headset price clearfix">
				...
				<h4>Basic</h4>
				<span><sup>$</sup>25<sub>/mo</sub></span>
			</div>
			...
			<a href="#contact" class="button featured animate">Sign Up</a>
		</div><!-- .columns -->

		<div class="one-third column box light featured">
			<div class="headset price clearfix">
				<img src="img/empty.gif" alt="" class="large-icons icon-shopcart" />
				<h4>Eshop</h4>
		...
		<div class="one-third column">
			<div class="headset price clearfix">
				...
				<h4>Custom</h4>
				<span><sup>$</sup>40<sub>/mo</sub></span>
			</div>
			<div class="bottom-gradient add-top add-bottom">
				<span class="left"></span>
				<span class="center"></span>
