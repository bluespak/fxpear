...
%>
	...
	<div id="content">
    	<div id="result-list" class="resultbox span6" style="overflow-y:-moz-hidden-unscrollable; height: 100%; position: absolute; margin-left: 0px !important; margin-top:-20px;border-right: 1px solid #ddd; background: #eee">
	<c:choose>
		<c:when test="${!empty info.result}">
          <c:forEach items="${info.result}" var="list" varStatus="st">
	...
	<div class="post">
        ...
        <div class="list-wrap">
		 	...
		 	<div class="span6 list-wrap-inner" style="border-bottom: 1px dashed #ddd; padding: 10px 0 10px; margin-top: 10px; margin-left: 0px; padding-left: 10px; max-width: 530px">
		        ...
		        <div id="the-post" style="display: inline-block; background: #f5f5f5; padding: 12px; float: right">
		            <ul class="unstyled mo">
		                <li>${list.sccd}</li>
		                <li class="mo" style="font-size: 24px; color: rgb(95, 49, 144);white-space: nowrap; overflow: hidden; max-width: 151px; min-width: 100px"><b style="font-weight: bold"><%=CurrencySymbol.getText((String)request.getAttribute("csymbol")) %><fmt:formatNumber value="${list.samt}" pattern=""/></b></li>
		            </ul>
		        </div>
		    </div>
       ...
       <div class="pagination pagination-small pagination-centered" style="position:fixed ;top:90%;left:13%;z-index:-1">
    	<ul>
			<li><a href="displayLinks();">Prev</a></li>
			<li><a href="javascript:displayLinks(1);">1</a></li>
			<li><a href="javascript:displayLinks(2);">2</a></li>
			<li><a href="javascript:displayLinks(3);">3</a></li>
			<li><a href="javascript:displayLinks(4);">4</a></li>
			<li><a href="javascript:displayLinks(5);">5</a></li>
			<li><a href="#">Next</a></li>
		</ul>
	  </div>       
