...
<html lang="en">  
  <head>
    ...
    <style>
        ...
        padding-top: 50px;
        padding-bottom: 20px;
				background: url("../fxpear/bootstrap331/img/money.jpg");
        }
    </style>
...
*/			
	...
	<div class="jumbotron text-center" style="background: none; padding-bottom: 0; margin-bottom: 0; padding-top: 0">
		<img class="img-responsive" style="margin-left: auto; margin-right: auto" src="../fxpear/bootstrap331/img/pearapp.png">
	...
	<script src="./bootstrap331/js/jquery.js"></script>
