...
<html lang="en">
  ...
  <body>
    ...
    <script src="../bootstrap-formhelpers-states.en_US.js"></script>
    <script src="../bootstrap-formhelpers-states.js"></script>
    <script src="../bootstrap-formhelpers-currencies.en_US.js"></script>
